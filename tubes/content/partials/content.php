    <div class="content-wrapper">        
        ...
        <div class="containers">
                ...
                <!-- isi-1 -->
                <p>Nintendo adalah sebuah perusahaan yang dimana Nintendo sendiri adalah konsumer elektronik multinasional dan perusahaan permainan video yang berkantor pusat di Kyoto. Awalnya merupakan perusahaan kartu yang kemudian berkembang dari perusahaan mainan hingga menjadi perusahaan permainana video, Ninendo merupakan salah satu PERUSAHAAN PERMAINAN VIDEO terbesar di dunia dari kapitalisasi pasar menciptakan beberapa waralaba permainan yang terkenal dan yang terlaris sepanjang masa, seperti Mario, The Legend of Zelda, Animal Crossing, dan Pokemon.</p>
                <!-- isi-2 -->
        ...
        <div class="containers">
                ...
                <p>Sebuah console keluarga dari nintendo, yang release pada tahun 2017 yang bisa dibilang menggantikan Nintendo DS, device ini terdapat kata-kata switch diakhir karena memiliki 3 cara untuk di pakai yaitu handheld, tabletop dan tv. di saat mode Tabletop dan TV mode, controler dari nintendo Switch ini bisa dilepas. Tapi disaat mode handheld controler dari Nintendo switch terpasang di layar nya seperti psVita tetapi dengan layar yang lebih besar.</p>
        </div>
